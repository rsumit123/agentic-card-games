...
export function SeatBadge({ player, name, isMe, active, holeCards, style }: { player: PublicPlayer; name: string | null; isMe: boolean; active: boolean; holeCards: Card[] | null; style: CSSProperties }) {
