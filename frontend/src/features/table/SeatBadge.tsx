...
export function SeatBadge({ player, name, isMe, active, holeCards, markers, style }: { player: PublicPlayer; name: string | null; isMe: boolean; active: boolean; holeCards: Card[] | null; markers: string[]; style: CSSProperties }) {
